...
CORE_FILES=(agent.py bot.py main.py cli.py cli_render.py discord_bot.py learning.py tools_builtin.py scheduler.py requirements.txt scripts/update.sh hydrabot VERSION)
FAILED=()
mkdir -p scripts
